...
import com.mastercard.gateway.common.StreamManager.Companion.EVENT_DISCONNECTED
import com.mastercard.gateway.common.StreamManager.Companion.EVENT_ERROR
import com.mastercard.gateway.common.StreamManager.Companion.EVENT_READ
...
class SocketClientTest {
    ...
    private lateinit var socketClient: SocketClient
        ...
        fun testConnectFirstDisconnectsThenStartsNewConnectionThread() {
            doNothing().whenever(socketClient).startConnectThread(1)
        ...
        fun testRunConnectExceptionClosesAndSendsDisconnectMessage() {
            ...
            doThrow(mockException).whenever(socketClient).attemptConnection(any())

            val mockMessage: Message = mock()
            doReturn(mockMessage).whenever(mockHandler).obtainMessage(EVENT_ERROR, mockException)
